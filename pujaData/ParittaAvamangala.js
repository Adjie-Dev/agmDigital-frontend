export const ParittaAvamanggala = [
    {
        title: 'Vandana',
        duration: '4:30',
        description: 'Penghormatan',
        audioUrl: '#',
        paliText: `• Namo Sanghyang Ādi Buddhaya (3 X)
• Namo Tassa Bhagavato Arahato Sammāsambuddhassa (3 X)
• Namo Sabbe Bodhisattāya-Mahasattāya (3 X)`,

        translation: `• Terpujilah Sanghyang Adi Buddha, Tuhan Yang Maha Esa (3 X).

• Terpujilah Bhagavā, Yang Maha Suci yang telah mencapai Penerangan Sempurna. (3 X).

• Terpujilah Para Bodhisatta – Mahasattaa. (3 X).`
    },
    {
        title: 'TISARANA',
        duration: '4:30',
...
• Untuk ketiga kalinya aku berlindung kepada Saṅgha.`
    },
    {
        title: 'BUDDHĀNUSSATI',
        duration: '4:30',
        description: 'Perenungan tentang Buddha',
        audioUrl: '#',
...
• Satthā devamanussānaṁ buddho bhagavā ‘ti,`,
        ...
        translation: `• Demkianlah Sang Bhagavā, Yang Maha Suci,
...
• Guru para Dewa dan Manusia, Yang sadar, Yang Patut Dimuliakan.`
    ...
    {
        title: 'PABBATOPAMA GĀTHĀ',
        duration: '4:30',
        description: 'Syair dengan perumpamaan gunung',
        audioUrl: '#',
        paliText: `• Yathāpi selā vipulā,
...
`,
        ...
        translation: `• Bagaikan gunung batu cadas yang besar
...
• dan setelah meninggal ia berbahagia di alam surga.`
    ...
    {
        title: 'ARIYADHANA GĀTHĀ',
        duration: '4:30',
        description: 'Syair tentang Kekayaan Mulia',
        audioUrl: '#',
        paliText: `• Yassa saddhā tathāgate
• Acalā supatiṭṭhitā
...
• Saraṁ buddhāna sāsananti`,
        ...
        translation: `• Ia yang yakin pada Tathāgata
...
• Dengan selalu mengingat Buddha Sāsana`
    ...
    {
        title: 'DHAMMANIYAMA SUTTA',
        duration: '4:30',
        description: 'Ketetapan Dhamma',
        audioUrl: '#',
        paliText: `• Evam-me sutaṁ:
...
`
    ...
    {
        title: 'TILAKKHAṆĀDIGĀTHĀ',
        duration: '4:30',
        description: 'penyokong kehidupan',
        audioUrl: '#',
        paliText: `• Sabbe saṅkhārā aniccāti
...
• Te loke parinibbutā ‘ti`,
        ...
        translation: `• Pada saat ia yang bijaksana melihat dengan jelas,
...
`
    ...
    {
        title: 'PAṬICCASAMUPPᾹDA PᾹṬHO',
        duration: '4:30',
        description: 'Hukum Sebab-Akibat Bergantungan',
        audioUrl: '#',
        paliText: `• Avijjāpaccayā saṅkhārā, 
...
• Nirodho hoti.`,
        ...
        translation: `• Dari ketidak tahuan muncullah faktor-faktor mental,
...
`
    },
    {
        title: 'VIJAYA SUTTA',
        duration: '4:30',
        description: 'Sutta tentang Kemenangan.',
        audioUrl: '#',
        paliText: `• Caram vā yadi vā tiṭṭhaṁ
...
`,
        ...
        translation: `• Berjalan atau berdiri
...
`
    ...
    {
        title: 'TIROKUḌḌA SUTTA',
        duration: '4:30',
        description: 'Khotbah tentang mereka yang berada di luar dinding.',
        audioUrl: '#',
        paliText: `• Tirokuddesu tiṭṭhanti
...
`,
        ...
        translation: `• Makhluk-makhluk peta memasuki pekarangan mereka 
...
• Tada sanak keluarga yang hidup dalam waktu lama
• Semua tergantung hasil perbuatannya
• Kami melakukan peresembahand
...
• Dengan segenap tenaga melakukan persembahan kepada para bhikkhud
...
`
    },
    {
        ...
        audioUrl: '#',
        paliText: `• Sabbāvamaṅgala muppadava dunnimittaṁ
...
`,
        ...
        translation: `• Semoga semua kemalangan, kesulitan dan tanda-tanda jelek
...
`
    ...
    {
        title: 'SUMAṄGALA GĀTHĀ II',
        duration: '4:30',
        description: 'Syair Kedua tentang Keberkahan.',
        audioUrl: '#',
        paliText: `• Bhavatu sabbamaṅgalaṁ
...
`,
        ...
        translation: `• Semoga semua memperoleh berkah
...
`
    ...
    {
        title: 'JĪVITAṀ ANIYATAṀ, MARANAṀ NIYATAṀ',
        duration: '4:30',
        description: 'Kehidupan tidak pasti, kematian adalah pasti.',
        audioUrl: '#',
        paliText: `• Aniccā vata saṅkhārā
• Uppādavaya dhammino
...
`,
        ...
        translation: `• Semua bentukan adalah tidak kekal
...
`
    ...
    {
        title: 'PAṀSUKULĀ GĀTHĀ',
        duration: '4:30',
        description: 'syair untuk upacara pelepasan jenazah.',
        audioUrl: '#',
        paliText: `• Aniccā vata saṅkhārā
• Uppādavaya dhammino
• Uppajjitvā nirujjhanti
...
`
    },
    {
        title: 'ETTĀVATĀ',
        duration: '4:30',
        description: 'Sejauh kebajikan ini.',
        audioUrl: '#',
